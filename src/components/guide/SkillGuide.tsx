...
- Checklist: \`references/checklist.md\``
    ...
    },
    {
      ...
      triggers: ['+figma', '+design to code', '+figma component'],
    ...
    {
      name: 'ai-tool-setup',
      description: 'Generate and update AI instruction files for supported tools',
      badge: 'Setup',
      color: 'text-teal-600',
      triggers: ['+setup ai tool', '+configure copilot', '+configure claude'],
      antiTriggers: ['Feature implementation', 'Code refactoring'],
      assets: ['copilot-instructions.template.md', 'claude.template.md', 'cursor-rules.template'],
      references: ['tool-formats.md'],
      scripts: ['check-and-install-pyyaml.sh', 'render-template.py'],
    },
  ]
