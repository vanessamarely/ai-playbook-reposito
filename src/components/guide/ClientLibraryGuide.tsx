    ...
    <div className="space-y-6">
      <Alert className="border-orange-200 bg-orange-50 dark:bg-orange-950/20">
        ...
        <AlertDescription className="text-orange-800 dark:text-orange-200">
          ...
          (like Waterworks) are kept separate to maintain portability and avoid coupling.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Understanding Waterworks (Client Library Example)
          </CardTitle>
          <CardDescription>
            Waterworks is a client-specific component library with unique style rules and architectural patterns
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="bg-muted/50 p-4 rounded-lg">
            <h3 className="font-semibold mb-3 flex items-center gap-2">
              ...
              Where Waterworks Documentation Lives
            </h3>
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <FolderOpen className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                <div>
                  <code className="font-medium">.github/copilot-instructions/waterworks-overrides.md</code>
                  <p className="text-muted-foreground mt-1">
                    Copilot-specific overrides for Waterworks style rules (no semicolons, no code comments)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <FolderOpen className="h-4 w-4 text-primary shrink-0 mt-0.5" />
                <div>
                  <code className="font-medium">.github/skills/waterworks-library/</code>
                  <p className="text-muted-foreground mt-1">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-900">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm text-green-900 dark:text-green-100">✓ Waterworks-Specific</CardTitle>
              </CardHeader>
              <CardContent className="text-xs space-y-1.5 text-green-800 dark:text-green-200">
                <li>No semicolons in code</li>
                <li>No comments inside code blocks</li>
                <li>Follow existing architecture patterns</li>
                <li>Client-specific component library</li>
                <li>Private documentation and context files</li>
              </CardContent>
            </Card>
      ...
      <Card className="bg-accent/5 border-accent/20">
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            ...
            Example: Waterworks Skill Structure
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="bg-background p-4 rounded-lg font-mono text-xs space-y-2">
            <div className="text-muted-foreground">waterworks-library/</div>
            <div className="ml-4">
              ...
              <div className="ml-4">
                <div className="text-foreground">│   ├── no-semicolons.md <span className="text-muted-foreground">(Code style rationale)</span></div>
      ...
      <Alert className="border-primary/20 bg-primary/5">
        ...
        <AlertDescription className="text-sm">
          Never reference client-specific rules (like Waterworks) in the general framework skills like
