...
Related skills
- Use the `figma-component` skill for mapping design→code conventions (see `.claude/skills/figma-component/SKILL.md`).

Contact & maintenance
- Keep this file in `.claude/agents/figma-component-builder.md`. Update the examples if the MCP endpoints or invocation script changes.
</content>
