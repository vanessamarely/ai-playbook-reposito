...
when_to_use: create API endpoint, build microservice, Node.js service, TypeScript backend, add route handler, implement REST endpoint, add request validation
---
