...
2. Load the matching skill from `ai-playbook/.claude/skills/<name>/SKILL.md` (Claude Code auto-discovers skills under `.claude/skills/` — copy or symlink the playbook's skills into this project's own `.claude/skills/` so they're picked up automatically).
