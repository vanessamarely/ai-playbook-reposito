...
when_to_use: convert figma to component, figma component generation, build component from figma node, map figma design system component, generate tsx from figma
---
...
When generating code changes, output minimal, reviewable diffs (using Claude Code's Edit/Write tools directly, not a manual patch format).
