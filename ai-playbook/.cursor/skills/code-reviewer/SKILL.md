...
## Related Skills
- `.cursor/skills/react-components/SKILL.md` — React-specific patterns
- `.cursor/skills/node-typescript-service/SKILL.md` — Backend patterns
- `.cursor/skills/a11y-automation/SKILL.md` — Accessibility checks
