...
1. Read: `.cursor/skills/react-components/references/a11y-wcag22.md`
2. Check for:
...
1. Check that `.github/copilot-instructions.md`, `CLAUDE.md`, `.cursor/rules/`, `.cursor/skills/`, and `AGENTS.md` are all consistent with any updated skill routing.
