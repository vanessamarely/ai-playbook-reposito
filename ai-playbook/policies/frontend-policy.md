...
### Detailed Guidelines
Refer to the react-components skill/prompt/rule's WCAG 2.2 reference material for your AI tool (e.g. `.claude/skills/react-components/references/a11y-wcag22.md` for Claude Code) for comprehensive mapping and implementation patterns.
