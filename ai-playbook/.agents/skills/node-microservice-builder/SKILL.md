...
description: Scaffold or extend Node.js/TypeScript microservices with validation, error handling, and testing. Use when the user wants to create or modify an API endpoint, service layer, or route handler in Express, Nest.js, or Fastify.
---

# Skill: Node Microservice Builder
...
Read: `.agents/skills/node-typescript-service/SKILL.md`
...
Refer to: `.agents/skills/node-typescript-service/references/validation-and-errors.md`
...
**Session Context**: When this skill completes, session logs should show:
