...
- Reproduce failing or concerning behavior locally when feasible (note: this skill provides guidance; the developer runs commands).
...
## Error Handling
If the skill cannot access a file, report: check path, permissions, and workspace membership.
...
## Integration Notes
This skill provides feedback in chat and returns a structured review. It does not modify files or commit changes. Use the related skills for deeper, focused checks.

## Related Skills
- `.agents/skills/react-components/SKILL.md` — React-specific patterns
- `.agents/skills/node-typescript-service/SKILL.md` — Backend patterns
- `.agents/skills/a11y-automation/SKILL.md` — Accessibility checks
