---
name: scan-workspace
description: Scan a workspace folder to detect project type and route to appropriate skills and AI tool configurations. Use when the user wants to identify a project's type/framework, find which skills apply, or verify AI tool instruction files are present and up to date.
---
...
| OpenAI Codex CLI | `AGENTS.md` | Recommended |
