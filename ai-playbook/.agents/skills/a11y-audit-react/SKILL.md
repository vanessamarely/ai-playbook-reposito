...
description: Audit React components for WCAG 2.2 compliance and suggest fixes. Use when the user wants an accessibility review of existing React component code (as opposed to running automated CI checks or building new components).
---

# Skill: Accessibility Audit (React)
...
Execute: `.agents/skills/a11y-automation/scripts/run-a11y-lint.sh <targetPath>`
...
Read: `.agents/skills/react-components/references/a11y-wcag22.md`
...
- Reference `.agents/skills/a11y-automation/scripts/run-axe-playwright.mjs`.
...
Quick reference for WCAG 2.1 AA compliance. Use alongside the `react-components` skill.
