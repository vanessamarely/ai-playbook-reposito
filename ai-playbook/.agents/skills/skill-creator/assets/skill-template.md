---
name: skill-name
description: Brief action-oriented description of what this skill accomplishes and when it should be used. Codex frontmatter supports only `name` and `description` — no `triggers`, `when_to_use`, or `allowed-tools` fields.
---
...
- Related skill: `.agents/skills/other-skill/SKILL.md`
