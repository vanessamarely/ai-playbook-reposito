...
Refer to: `.agents/skills/react-components/references/react-ts-patterns.md`
...
Validate against: `.agents/skills/react-components/references/a11y-wcag22.md`
...
**Invalid ARIA combination**: Refer to `.agents/skills/react-components/references/a11y-wcag22.md` for correct usage.
