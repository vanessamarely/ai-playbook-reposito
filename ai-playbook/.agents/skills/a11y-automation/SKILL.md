...
Execute: `node .agents/skills/a11y-automation/scripts/run-axe-playwright.mjs <targetPath>`
...
Refer to: `.agents/skills/react-components/references/a11y-wcag22.md`
...
- WCAG 2.2 Guidelines: `.agents/skills/react-components/references/a11y-wcag22.md`
