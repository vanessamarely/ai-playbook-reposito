...
- Canonical Claude Code source: `.claude/agents/a11y-audit-react.md`
- Copilot custom agent equivalent: `.github/agents/a11y-audit-react.agent.md`
- Related skills: `.github/skills/a11y-automation/SKILL.md`, `.github/skills/react-components/SKILL.md`
