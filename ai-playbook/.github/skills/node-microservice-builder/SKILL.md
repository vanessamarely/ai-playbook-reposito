...
- Canonical Claude Code source: `.claude/agents/node-microservice-builder.md`
- Copilot custom agent equivalent: `.github/agents/node-microservice-builder.agent.md`
- Related skill: `.github/skills/node-typescript-service/SKILL.md`
