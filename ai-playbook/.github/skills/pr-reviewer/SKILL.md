...
- `../../policies/workspace-policy.md` (always)
...
1. Check that `.github/copilot-instructions.md`, `CLAUDE.md`, `.cursor/rules/`, and `AGENTS.md` are all consistent with any updated skill routing.
...
- Canonical Claude Code source: `.claude/agents/pr-reviewer.md`
- Copilot custom agent equivalent: `.github/agents/pr-reviewer.agent.md`
