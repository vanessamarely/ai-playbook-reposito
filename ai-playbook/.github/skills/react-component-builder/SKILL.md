...
- Canonical Claude Code source: `.claude/agents/react-component-builder.md`
- Copilot custom agent equivalent: `.github/agents/react-component-builder.agent.md`
- Related skill: `.github/skills/react-components/SKILL.md`
